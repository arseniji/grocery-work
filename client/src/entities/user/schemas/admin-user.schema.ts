...
export const AdminUserAddSchema = validator.object({
  login: validator
    .string()
...
export const AdminUserEditSchema = validator.object({
  login: validator
    .string()
    .min(3, { message: "Минимальная длинна 3" })
    .max(50, { message: "Максимальная длина 50" })
...
export type AdminUserAddType = Infer<typeof AdminUserAddSchema>;
export type AdminUserEditType = Infer<typeof AdminUserEditSchema>;
